package Producto.example.Producto;
...
public class ProductoApplication {
	...
	private static final Logger log = LoggerFactory.getLogger(ProductoApplication.class);
	...
	private static void createDatabaseIfNotExists() {
		String url      = System.getenv().getOrDefault("SPRING_DATASOURCE_URL",
		                  "jdbc:postgresql://localhost:5432/Producto");
